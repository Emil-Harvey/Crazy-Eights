...
def dynamics():  #initialise dynamic elements (buttons etc)
	Label(ctr_right, text=" Enter Name ", font=("system", 12), bg="darkgreen", fg="yellow2", relief="sunken").grid(
		row=0, pady=10)
	...
	quitbutton = Button(ctr_right, text="Quit Game", font=("system", 12), bg="palegoldenrod", fg="#420",
...
def highscores():  #gather, sort & display highscores
	...
	for num in range(min(len(Hiscores), 10)):
		#if num < 10:
